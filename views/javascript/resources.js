          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if (data.moreData && data.logged) {
                ...
                picture.src = "/resourceImages/" + data.title + data.id +
                  "." + data.ext;
                console.log("/resourceImages/" + data.title + data.id +
                  "." + data.ext);
                picture.className = "scrap";
                var authorPic = document.createElement('img');
                authorPic.className = "author";
                authorPic.src = "/images/" + data.author + data.usrID +
                  "." + data.authorExt;
                ...
                var number_of_comments = document.createElement('p');
                number_of_comments.className = "numOfComm";
                starDiv.appendChild(number_of_comments);
                number_of_comments.innerHTML = "Raters: " + data.num_rating;
                switch (data.rank) {
                case -1:
